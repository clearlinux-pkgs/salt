...
Source0  : https://github.com/saltstack/salt/releases/download/v3004.1/salt-3004.1.tar.gz
...
%prep
%setup -q -n salt-3004.1
cd %{_builddir}/salt-3004.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650567649
...
cp %{_builddir}/salt-3004.1/LICENSE %{buildroot}/usr/share/package-licenses/salt/c0f0fb1c856a87d9fc4a59bd2ec0d6b19907a94f
cp %{_builddir}/salt-3004.1/pkg/osx/pkg-resources/license.rtf %{buildroot}/usr/share/package-licenses/salt/906ed1fd66d444e951c0f5f38131d1dd61dfcf7c
cp %{_builddir}/salt-3004.1/pkg/windows/installer/LICENSE.txt %{buildroot}/usr/share/package-licenses/salt/712d25aaeea79cb25612195315109efc884cc5d6
cp %{_builddir}/salt-3004.1/tests/pytests/unit/modules/sol10_pkg/bashs/SUNWbashS/install/copyright %{buildroot}/usr/share/package-licenses/salt/869dfc8f2ae39a287e88ffca20966beab5b08ab8
