...
Version  : 2019.2.3
Release  : 1
URL      : https://github.com/saltstack/salt/releases/download/v2019.2.3/salt-ssh-2019.2.3.tar.gz
Source0  : https://github.com/saltstack/salt/releases/download/v2019.2.3/salt-ssh-2019.2.3.tar.gz
...
%prep
%setup -q -n salt-ssh-2019.2.3
cd %{_builddir}/salt-ssh-2019.2.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579202705
...
cp %{_builddir}/salt-ssh-2019.2.3/pkg/osx/pkg-resources/license.rtf %{buildroot}/usr/share/package-licenses/salt/5ac0caf8c8f8209b518d0ac5d21e5d27051d1676
cp %{_builddir}/salt-ssh-2019.2.3/pkg/windows/installer/LICENSE.txt %{buildroot}/usr/share/package-licenses/salt/712d25aaeea79cb25612195315109efc884cc5d6
