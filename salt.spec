...
Version  : 3002.1
Release  : 6
URL      : https://github.com/saltstack/salt/releases/download/v3002.1/salt-3002.1.tar.gz
Source0  : https://github.com/saltstack/salt/releases/download/v3002.1/salt-3002.1.tar.gz
...
%prep
%setup -q -n salt-3002.1
cd %{_builddir}/salt-3002.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604691924
...
cp %{_builddir}/salt-3002.1/LICENSE %{buildroot}/usr/share/package-licenses/salt/c0f0fb1c856a87d9fc4a59bd2ec0d6b19907a94f
cp %{_builddir}/salt-3002.1/pkg/osx/pkg-resources/license.rtf %{buildroot}/usr/share/package-licenses/salt/5ac0caf8c8f8209b518d0ac5d21e5d27051d1676
cp %{_builddir}/salt-3002.1/pkg/windows/installer/LICENSE.txt %{buildroot}/usr/share/package-licenses/salt/712d25aaeea79cb25612195315109efc884cc5d6
