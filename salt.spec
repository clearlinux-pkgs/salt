...
Version  : 3003.3
Release  : 20
URL      : https://github.com/saltstack/salt/releases/download/v3003.3/salt-3003.3.tar.gz
Source0  : https://github.com/saltstack/salt/releases/download/v3003.3/salt-3003.3.tar.gz
...
%prep
%setup -q -n salt-3003.3
cd %{_builddir}/salt-3003.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630625698
...
cp %{_builddir}/salt-3003.3/LICENSE %{buildroot}/usr/share/package-licenses/salt/c0f0fb1c856a87d9fc4a59bd2ec0d6b19907a94f
cp %{_builddir}/salt-3003.3/pkg/osx/pkg-resources/license.rtf %{buildroot}/usr/share/package-licenses/salt/906ed1fd66d444e951c0f5f38131d1dd61dfcf7c
cp %{_builddir}/salt-3003.3/pkg/windows/installer/LICENSE.txt %{buildroot}/usr/share/package-licenses/salt/712d25aaeea79cb25612195315109efc884cc5d6
